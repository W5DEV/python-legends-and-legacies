...
displayed_warlock_spells = ["Burning Hands", "Charm Person", "Color Spray", "Comprehend Languages", "Detect Magic", "Disguise Self", "Expeditious Retreat", "False Life", "Feather Fall", "Fog Cloud", "Jump", "Mage Armor", "Magic Missile", "Shield", "Silent Image", "Sleep", "Thunderwave"]
warlock_spells = ["burning hands", "charm person", "color spray", "comprehend languages", "detect magic", "disguise self", "expeditious retreat", "false life", "feather fall", "fog cloud", "jump", "mage armor", "magic missile", "shield", "silent image", "sleep", "thunderwave"]
displayed_warlock_cantrips = ["Acid Splash", "Chill Touch", "Dancing Lights", "Fire Bolt", "Light", "Mage Hand", "Mending", "Message", "Minor Illusion", "Poison Spray", "Prestidigitation", "Ray of Frost", "Shocking Grasp", "True Strike"]
warlock_cantrips = ["acid splash", "chill touch", "dancing lights", "fire bolt", "light", "mage hand", "mending", "message", "minor illusion", "poison spray", "prestidigitation", "ray of frost", "shocking grasp", "true strike"]
...
displayed_warlock_skills = ["Arcana", "Deception", "Insight", "Intimidation", "Persuasion", "Religion"]
warlock_skills = ["arcana", "deception", "insight", "intimidation", "persuasion", "religion"]
...
def define_warlock():
    ...
    # Starting Cantrips
    print("You have reached level 1 and can now choose 4 cantrips from the warlock spell list.")
    ...
    while cantrip_choice3.lower() not in warlock_cantrips:
        print("That is not a valid choice. Please choose from the list.")
        cantrip_choice3 = input("> ")
    cantrip_choice4 = input("> ")
    while cantrip_choice4.lower() not in warlock_cantrips:
        print("That is not a valid choice. Please choose from the list.")
        cantrip_choice4 = input("> ")
    ...
    if equipment_choice3.lower() == "priest's pack":
        ...
        warlock.starting_equipment.append(equipment.priests_pack)
        ...
        warlock.starting_equipment.append(equipment.explorers_pack)

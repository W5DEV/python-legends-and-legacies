...
def define_paladin():
    ...
    if first_equipment_choice == "Mace":
        paladin.starting_equipment.append(equipment.mace)
    elif first_equipment_choice == "Warhammer":
        paladin.starting_equipment.append(equipment.war_hammer)
    ...
    if second_equipment_choice == "Scale Mail":
        paladin.starting_equipment.append(equipment.scale_mail_medium_armor)
    elif second_equipment_choice == "Leather Armor":
        paladin.starting_equipment.append(equipment.leather_light_armor)
    ...
    if third_equipment_choice == "Light Crossbow":
        paladin.starting_equipment.append(equipment.light_crossbow)
    else:
    ...
    paladin.starting_equipment.append(equipment.shield)
    ...
    ### Cantrip Choices ###
    for i in range(3):
        cantrip = cantrips.select_cantrips("paladin")
        paladin.cantrips.append(cantrip)

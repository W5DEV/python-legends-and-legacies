...
def define_warlock():
    ...
    if first_equipment_choice == "Mace":
        warlock.starting_equipment.append(equipment.mace)
    elif first_equipment_choice == "Warhammer":
        warlock.starting_equipment.append(equipment.war_hammer)
    ...
    if second_equipment_choice == "Scale Mail":
        warlock.starting_equipment.append(equipment.scale_mail_medium_armor)
        ...
        warlock.starting_equipment.append(equipment.chain_mail_heavy_armor)
    ...
    warlock.starting_equipment.append(equipment.shield)
    warlock.starting_equipment.append(equipment.holy_symbol_emblem)

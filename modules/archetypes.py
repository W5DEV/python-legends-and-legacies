...
import modules.archetype_abilities as archetype_abilities
...
class Barbarian:
    ...
    def update_special_abilities(self, level):
        ...
        if level >= 3:
            print("You have reached level 3 and can now choose a Primal Path.")
            print("Please choose between the Path of the Berserker or the Path of the Totem Warrior.")
            primal_path_choice = input("> ")
            if primal_path_choice.lower() == "path of the berserker":
                self.primal_path = "Path of the Berserker"
                self.special_abilities.append("Frenzy")
            elif primal_path_choice.lower() == "path of the totem warrior":
                self.primal_path = "Path of the Totem Warrior"
                self.special_abilities.append("Spirit Seeker")
                self.special_abilities.append("Totem Spirit")
        if level >= 4:
        ...
        if level >= 6:
            ...
            elif self.primal_path == "Path of the Totem Warrior":
                self.special_abilities.append("Aspect of the Beast")
        if level >= 7:
        ...
        if level >= 10:
            if self.primal_path == "Path of the Berserker":
                ...
                self.special_abilities.append("Spirit Walker")
        if level >= 11:
        ...
        if level >= 14:
            if self.primal_path == "Path of the Berserker":
                ...
                self.special_abilities.append("Totemic Attunement")
        if level >= 15:
